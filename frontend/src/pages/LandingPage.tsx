            ...
            <main className="mt-10 mx-auto max-w-7xl px-4 sm:mt-12 sm:px-6 md:mt-16 lg:mt-20 lg:px-8 xl:mt-28">
              ...
              >
                <h1 className="text-4xl tracking-tight font-extrabold sm:text-5xl md:text-6xl">
                  ...
                  <span className="block text-blue-600">Manage your time</span>
                </h1>
                <p className="mt-3 text-base text-gray-300 sm:mt-5 sm:text-lg sm:max-w-xl sm:mx-auto md:mt-5 md:text-xl lg:mx-0">
                  Boost your productivity with our intuitive task management and time tracking solution.
                  Organize your work, track your progress, and achieve your goals.
                </p>
...
const features = [
  ...
  {
    name: 'Time Tracking',
    description: 'Track time spent on tasks and projects. Get insights into your productivity and work patterns.',
    icon: (props: any) => (
      <svg
        fill="none"
        viewBox="0 0 24 24"
  ...
  },
  {
    ...
    description: 'View detailed statistics and reports about your productivity and task completion rates.',
    icon: (props: any) => (
      <svg
        fill="none"
        viewBox="0 0 24 24"
  ...
  },
  {
    ...
    description: 'Get instant notifications and updates about your tasks and team activities.',
    icon: (props: any) => (
      <svg
        fill="none"
        viewBox="0 0 24 24"
